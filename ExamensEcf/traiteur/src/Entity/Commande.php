...
public function setVillePrestation(?string $ville_prestation): static
{
    ...
    public function isRetourMateriel(): ?bool
    {
        return $this->retour_materiel;
    }

    public function setRetourMateriel(bool $retour_materiel): static
    {
        $this->retour_materiel = $retour_materiel;
